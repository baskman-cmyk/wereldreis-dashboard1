        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xs space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 dark:border-slate-800 pb-4">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  {car.category} • Geschikt voor 4 personen + 4 grote koffers & reiswiegen.
                </p>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="px-3 py-1 bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300 font-bold text-xs rounded-xl">
                  Geboekt (€{car.dagprijsEur}/dag)
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-xs font-semibold">
              <div className="p-4 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-100 dark:border-slate-700">
                <span className="text-slate-400 font-bold block text-[10px]">Huurklasse & Type</span>
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-100 dark:border-slate-700">
                ...
                <span className="text-xs font-bold text-slate-900 dark:text-white mt-1 block">
                  {car.ophaallocatie} ({car.ophaaldatum})
                </span>
              </div>
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-100 dark:border-slate-700">
                <span className="text-slate-400 font-bold block text-[10px]">Inleverlocatie</span>
                <span className="text-xs font-bold text-slate-900 dark:text-white mt-1 block">
                  {car.inleverlocatie} ({car.inleverdatum})
                </span>
              </div>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <p className="mb-2 text-[10px] font-black uppercase tracking-wider text-slate-400">Huurcontract</p>
                <PdfAttachmentControl
                  attachment={car.rentalContractPdf}
                  label="Huurcontract PDF uploaden"
                  onChange={(rentalContractPdf) =>
                    onUpdateCamper({ ...camper, carOption: { ...car, rentalContractPdf } })
                  }
                />
              </div>
              <div>
                <p className="mb-2 text-[10px] font-black uppercase tracking-wider text-slate-400">Verzekeringsbewijs</p>
                <PdfAttachmentControl
                  attachment={car.insurancePdf}
                  label="Verzekerings-PDF uploaden"
                  onChange={(insurancePdf) =>
                    onUpdateCamper({ ...camper, carOption: { ...car, insurancePdf } })
                  }
                />
              </div>
            </div>
